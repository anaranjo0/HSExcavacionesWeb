...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    ...
    <script type="text/javascript">  
        function Alertando(lnk) {
            //var row = lnk.parentNode.parentNode;
            //var rowIndex = row.rowIndex - 1; 
            //var valor = "hola";
            var slt = document.getElementById("GRDmaquinaria.DPEObra");
            //var inputval = "";
            //if (slt) {
            //    inputval = slt.value;
            //}
            ...
            //var valor = slt.options[slt.selectedIndex].index;
    ...
    <script runat="server">
        ...
        void GRDmaquinaria_RowUpdating (Object sender, GridViewUpdateEventArgs e)
        {
            ...
            //lblError.Text = "error" + doccliente;
            //IEnumerable<LibObras.ClsObra> Obras = model.SeleccionarObra(doccliente);
            ...
            //lblError.Text = lblError.Text + ' ' + Obras;
